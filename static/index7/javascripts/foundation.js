...
window.Modernizr = function(e, t, n) {
    ...
    return f.addTest = function(e, t) {
            if (typeof e == "object")
                for (var r in e) k(e, r) && f.addTest(r, e[r]);
            else {
                e = e.toLowerCase();
                if (f[e] !== n) return f;
...
function(e, t, n) {
    ...
    k = function(e) {
        ...
        if (i(e)) o(e, 0, h, 0);
            ...
            for (f = 0; f < e.length; f++) c = e[f], i(c) ? o(c, 0, h, 0) : S(c) ? k(c) : Object(c) === c && a(c, h);
...
e.fn.foundationMediaQueryViewer = function(t) {
    ...
    e(document).on("keyup.mediaQueryViewer", ":input", function(e) {
        e.which === n.toggleKey && e.stopPropagation()
    }), e(document).on("keyup.mediaQueryViewer", function(t) {
        var r = e("#fqv");
...
e(document).on("click", "a[data-reveal-id]", function(t) {
    ...
    return n = e.extend({}, i, n), this.each(function() {
        function c() {
            u = !1
        }
        ...
        function v() {
            ...
            }), t = !1), n.animation === "fade" && (i.animate({
                opacity: 0
            }, n.animationSpeed, function() {
                i.css(f.close)
            }), t ? i.trigger("reveal:closed") : a.delay(n.animationSpeed).fadeOut(n.animationSpeed, function() {
        ...
        }).insertAfter(i), a.fadeTo("fast", .8)), i.bind("reveal:open.reveal", d), i.bind("reveal:close.reveal", v), i.bind("reveal:opened.reveal reveal:closed.reveal", c), i.bind("reveal:closed.reveal", m), i.bind("reveal:open.reveal", n.open), i.bind("reveal:opened.reveal", n.opened), i.bind("reveal:close.reveal", n.close), i.bind("reveal:closed.reveal", n.closed), i.trigger("reveal:open"), l = e("." + n.dismissModalClass).bind("click.reveal", function() {
...
e.fn.foundationNavigation = function(t) {
    ...
    }), e(".nav-bar>li.has-flyout", this).addClass("is-touch")) : e(".nav-bar>li.has-flyout", this).hover(function() {
...
e.fn.foundationButtons = function(t) {
    e(document).on("click.fndtn", ".button.disabled", function(e) {
        e.preventDefault()
    }), e(".button.dropdown > ul", this).addClass("no-hover"), e(document).on("click.fndtn", ".button.dropdown, .button.dropdown.split span", function(e) {
        e.target === this && e.stopPropagation()
    }), e(document).on("click.fndtn", ".button.dropdown.split span", function(t) {
        t.preventDefault(), e(".button.dropdown", this).not(e(this).parent()).children("ul").removeClass("show-dropdown"), e(this).siblings("ul").toggleClass("show-dropdown")
    }), e(document).on("click.fndtn", ".button.dropdown:not(.split)", function(t) {
        e(".button.dropdown", this).not(this).children("ul").removeClass("show-dropdown"), e(this).children("ul").toggleClass("show-dropdown")
    }), e(document).on("click.fndtn", "body, html", function() {
        e(".button.dropdown ul").removeClass("show-dropdown")
    });
    var n = e(".button.dropdown:not(.large):not(.small):not(.tiny)", this).outerHeight() - 1,
        r = e(".button.large.dropdown", this).outerHeight() - 1,
        i = e(".button.small.dropdown", this).outerHeight() - 1,
        s = e(".button.tiny.dropdown", this).outerHeight() - 1;
    e(".button.dropdown:not(.large):not(.small):not(.tiny) > ul", this).css("top", n), e(".button.dropdown.large > ul", this).css("top", r), e(".button.dropdown.small > ul", this).css("top", i), e(".button.dropdown.tiny > ul", this).css("top", s), e(".button.dropdown.up:not(.large):not(.small):not(.tiny) > ul", this).css("top", "auto").css("bottom", n - 2), e(".button.dropdown.up.large > ul", this).css("top", "auto").css("bottom", r - 2), e(".button.dropdown.up.small > ul", this).css("top", "auto").css("bottom", i - 2), e(".button.dropdown.up.tiny > ul", this).css("top", "auto").css("bottom", s - 2)
}
})(jQuery);
(function(e) {
e.fn.foundationTabs = function(t) {
    ...
    e(document).on("click.fndtn", "dl.tabs dd a", function(t) {
        r(e(this).parent("dd"))
    }), window.location.hash && (r(e('a[href="' + window.location.hash + '"]').parent("dd")), n.callback())
}
})(jQuery);
/*
...
jQuery.foundation = jQuery.foundation || {}, jQuery.foundation.customForms = jQuery.foundation.customForms || {}, e.foundation.customForms.appendCustomMarkup = function(n) {
    ...
    function s(n, r) {
        ...
        if (o.length === 0) {
            var m = s.hasClass("small") ? "small" : s.hasClass("medium") ? "medium" : s.hasClass("large") ? "large" : s.hasClass("expand") ? "expand" : "";
            o = e('<div class="' + ["custom", "dropdown", m].join(" ") + '"><a href="#" class="selector"></a><ul /></div>"'), f = o.find(".selector"), u = o.find("ul"), p = l.map(function() {
                return "<li>" + e(this).html() + "</li>"
            }).get().join(""), u.append(p), v = o.prepend('<a href="#" class="current">' + c.html() + "</a>").find(".current"), s.after(o).hide()
        } else p = l.map(function() {
            return "<li>" + e(this).html() + "</li>"
        }).get().join(""), u.html("").append(p);
        o.toggleClass("disabled", s.is(":disabled")), d = u.find("li"), l.each(function(t) {
            this.selected && (d.eq(t).addClass("selected"), v && v.html(e(this).html()))
        }), u.css("width", "inherit"), o.css("width", "inherit"), o.is(".small, .medium, .large, .expand") || (o.addClass("open"), i.adjust(u), h = d.outerWidth() > h ? d.outerWidth() : h, i.reset(), o.removeClass("open"), o.width(h + 18), u.width(h + 16))
    }
    var r = {
...
var n = function(t) {
    ...
    r = function(e) {
        var t = e.prev(),
            n = t[0];
        !1 === t.is(":disabled") && (n.checked = n.checked ? !1 : !0, e.toggleClass("checked"))
    },
    i = function(t) {
        var n = t.prev(),
            r = n[0];
        !1 === n.is(":disabled") && (e('input:radio[name="' + n.attr("name") + '"]').each(function() {
...
e(document).on("click", "form.custom span.custom.checkbox", function(t) {
    ...
    var n = e("#" + e(this).attr("for")),
        s, o;
    n.length !== 0 && (n.attr("type") === "checkbox" ? (t.preventDefault(), s = e(this).find("span.custom.checkbox"), r(s)) : n.attr("type") === "radio" && (t.preventDefault(), o = e(this).find("span.custom.radio"), i(o)))
...
var t = {
        ...
        tipTemplate: function(e, n) {
            return '<span data-selector="' + e + '" class="' + t.tooltipClass.substring(1) + '">' + n + '<span class="nub"></span></span>'
        }
    },
    n = {
        init: function(r) {
            return this.each(function() {
                var r = e("body");
                Modernizr.touch ? (r.on("click.tooltip touchstart.tooltip touchend.tooltip", t.targetClass, function(r) {
                    r.preventDefault(), e(t.tooltipClass).hide(), n.showOrCreateTip(e(this))
                }), r.on("click.tooltip touchstart.tooltip touchend.tooltip", t.tooltipClass, function(t) {
                    t.preventDefault(), e(this).fadeOut(150)
                })) : r.on("mouseenter.tooltip mouseleave.tooltip", t.targetClass, function(t) {
                    var r = e(this);
                    t.type === "mouseenter" ? n.showOrCreateTip(r) : t.type === "mouseleave" && n.hide(r)
                })
            })
        },
        showOrCreateTip: function(e) {
            var t = n.getTip(e);
            t && t.length > 0 ? n.show(e) : n.create(e)
        },
        getTip: function(r) {
            var i = n.selector(r),
                s = null;
            return i && (s = e("span[data-selector=" + i + "]" + t.tooltipClass)), s.length > 0 ? s : !1
        },
        selector: function(e) {
            var t = e.attr("id"),
                n = e.data("selector");
            return t === undefined && n === undefined && (n = "tooltip" + Math.random().toString(36).substring(7), e.attr("data-selector", n)), t ? t : n
        },
        create: function(r) {
            var i = e(t.tipTemplate(n.selector(r), e("<div>").text(r.attr("title")).html())),
                s = n.inheritable_classes(r);
            i.addClass(s).appendTo("body"), Modernizr.touch && i.append('<span class="tap-to-close">tap to close </span>'), r.removeAttr("title"), n.show(r)
        },
        reposition: function(t, n, r) {
            var i, s, o, u, a, f;
            n.css("visibility", "hidden").show(), i = t.data("width"), s = n.children(".nub"), o = s.outerHeight(), u = s.outerWidth(), f = function(e, t, n, r, i, s) {
                return e.css({
                    top: t,
                    bottom: r,
                    left: i,
        ...
        show: function(e) {
            var t = n.getTip(e);
            n.reposition(e, t, e.attr("class")), t.fadeIn(150)
        },
        hide: function(e) {
            var t = n.getTip(e);
            t.fadeOut(150)
        ...
        reload: function() {
            var t = e(this);
            return t.data("tooltips") ? t.tooltips("destroy").tooltips("init") : t.tooltips("init")
        },
        destroy: function() {
            return this.each(function() {
                e(window).off(".tooltip"), e(t.targetClass).off(".tooltip"), e(t.tooltipClass).each(function(n) {
                    e(e(t.targetClass).get(n)).attr("title", e(this).text())
                }).remove()
            })
        }
    };
e.fn.tooltips = function(t) {
    ...
    e.error("Method " + t + " does not exist on jQuery.tooltips")
}
})(jQuery);
(function(e) {
e.fn.foundationAccordion = function(t) {
    e(document).on("click.fndtn", ".accordion li", function() {
        var t = e(this).children(".content").first();
        e(".accordion .content").not(t).hide().parent("li").removeClass("active"), t.show(0, function() {
...
e.fn.foundationAlerts = function(t) {
    ...
    e(document).on("click", ".alert-box a.close", function(t) {
        t.preventDefault(), e(this).closest(".alert-box").fadeOut(function(t) {
